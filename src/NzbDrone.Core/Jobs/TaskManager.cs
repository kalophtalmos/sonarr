            ...
            var defaultTasks = new[]
                {
                    ...
                    new ScheduledTask{ Interval = _configService.MovieRssSyncInterval,TypeName = typeof(MovieRssSyncCommand).FullName}, 
                    ...
                    new ScheduledTask{ Interval = 1, TypeName = typeof(CheckForFailedDownloadCommand).FullName},
                    new ScheduledTask{ Interval = 1,TypeName = typeof(DownloadedMovieScanCommand).FullName},
